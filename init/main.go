// migration controller for service
// iterates over schemas generated by go-migrate
// and runs optional data migrations
...
// waits for db to come up. times out after 3 minutes
...
// creates migration controller and tries to update db
func main() {
	config := initConfig()
